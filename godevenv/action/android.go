...
func androidAction() {
	...
	case "darwin":
		...
		base.ShRun("brew install java ;brew casks install android-commandlinetools  android-sdk android-messages android-ndk  android-platform-tools  androidtool  android-studio flutter")
	case "linux":
	case "win":
	}
}
